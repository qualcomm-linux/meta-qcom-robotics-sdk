# Contributing to meta-qcom-robotics-sdk
...
1. [Submit a pull request](https://github.com/qualcomm-linux/meta-qcom-robotics-sdk/pulls) from your branch to `scarthgap`.
