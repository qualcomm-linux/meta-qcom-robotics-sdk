...
5. Build using the KAS configuration for one of the supported boards
   ...
   kas build meta-qcom-robotics-sdk/ci/qcs6490-rb3gen2-core-kit.yml:meta-qcom-robotics-sdk/ci/linux-qcom-6.18.yml:meta-qcom-robotics-sdk/ci/qcom-robotics-image.yml
   ```
   Supported machines and distributions are listed below:
   | Machine Names | Distro Names |
   | ------------ | ------------ |
   | qcs6490-rb3gen2-core-kit | qcom-robotics-image, qcom-robotics-proprietary-image |
