...
2. Supported kas configurations
  ...
  3. Build Command(Example):<**MACHINE**: iq-9075-evk, **DISTRO**: qcom-robotics-distro>
   ...
   - The Arduino VENTUNO Q board is supported through the
     [meta-qcom-arduino](https://github.com/qualcomm-linux/meta-qcom-arduino) BSP layer, which
     `ci/ventuno-q.yml` pulls in automatically. Swap in the `ventuno-q` machine configuration:
